...
var GFCnpconnectcampaign = (function($) {
...
jQuery(function($) {
	...
	fieldSettings.connectcampaign = ".conditional_logic_field_setting, .error_message_setting, .label_setting, .admin_label_setting, .rules_setting, .description_setting, .css_class_setting, .gfcnpconnectcampaign_setting";
