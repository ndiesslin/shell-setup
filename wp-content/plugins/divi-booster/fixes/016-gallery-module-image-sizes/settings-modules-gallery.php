<?php $this->techlink('http://www.wpthemefaqs.com/change-divi-image-gallery-grid-thumbnail-sizes/'); ?>
...
<tr><td>Image width:</td><td id="wtfdivi016-width"><?php $this->numberpicker(__FILE__, 'imagewidth', 225, 0); ?>px</td></tr>
