...
foreach($option['customcss']['css'] as $k=>$v) { 
		...
		$options_mq = array(); 
		foreach($media_queries as $slug=>$data) { $options_mq[$slug] = $data['name']; }
...
?>
	...
	<div class="wtfdivi011_cssblock">
		...
		<tr><td>User type:</td><td><?php $this->selectpicker(__FILE__, '[customcss][user][]', $options_user, $selected_user); ?></td></tr>
		<tr><td>Page:</td><td><?php $this->selectpicker(__FILE__, '[customcss][pagetype][]', $options_pagetype, $selected_pagetype); ?></td></tr>
		<tr><td>Divi layouts:</td><td><?php $this->selectpicker(__FILE__, '[customcss][elegantthemes][]', $options_et, $selected_et); ?></td></tr>
		</table>	
		
		<table class="wtfdivi011_selector">
		<tr><td>Browser:</td><td><?php $this->selectpicker(__FILE__, '[customcss][browser][]', $options_browser, $selected_browser); ?></td></tr>
		<tr><td>Device:</td><td><?php $this->selectpicker(__FILE__, '[customcss][device][]', $options_device, $selected_device); ?></td></tr>
		<tr><td>Screen width:</td><td><?php $this->selectpicker(__FILE__, '[customcss][mediaqueries][]', $options_mq, $selected_mq); ?></td></tr>
		</table>		
