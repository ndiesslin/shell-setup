            ...
            <div class="clearfix">
              <div class="et_pb_column et_pb_column_1_2  et_pb_column_1">
                <div>
                  ...
                  <input type="checkbox" name="wpcf-physician-check" value="Yes" id="physician-yes" <?php echo in_array_r('Yes', getParameters(), false, 'wpcf-physician-check') ? 'checked' : ''; ?>><label for="physician-yes">Yes</label><br>
                  <input type="checkbox" name="wpcf-physician-check" value="No" id="physician-no" <?php echo in_array_r('No', getParameters(), false, 'wpcf-physician-check') ? 'checked' : ''; ?>><label for="physician-no">No</label>
                </div>
                <br>
                <div>
              ...
              <div class="et_pb_column et_pb_column_1_2  et_pb_column_1">
                <div>
                  ...
                  <input type="checkbox" name="wpcf-gender" value="Male" id="Male" <?php echo in_array_r('Male', getParameters(), false, 'wpcf-gender') ? 'checked' : ''; ?>><label for="Male">Male</label>
                  <input type="checkbox" name="wpcf-gender" value="Female" id="Female" <?php echo in_array_r('Female', getParameters(), false, 'wpcf-gender') ? 'checked' : ''; ?>><label for="Female">Female</label>
                </div>
                <br>
                <div>
                  <h3 class="text--purple display-inline text-bold">AGE</h3><br>
                  <input type="checkbox" name="wpcf-age-range" value="18-20" id="18-20" <?php echo in_array_r('18-20', getParameters(), false, 'wpcf-age-range') ? 'checked' : ''; ?>><label for="18-20">18-20</label><br>
                  <input type="checkbox" name="wpcf-age-range" value="21-74" id="21-74" <?php echo in_array_r('21-74', getParameters(), false, 'wpcf-age-range') ? 'checked' : ''; ?>><label for="21-74">21-74</label><br>
                  <input type="checkbox" name="wpcf-age-range" value="75-79" id="75-79" <?php echo in_array_r('75-79', getParameters(), false, 'wpcf-age-range') ? 'checked' : ''; ?>><label for="75-79">75-79</label><br>
                  <input type="checkbox" name="wpcf-age-range" value="80" id="80" <?php echo in_array_r('80+', getParameters(), false, 'wpcf-age-range') ? 'checked' : ''; ?>><label for="80">80+</label>
                </div>
              </div>
              <!-- <div class="et_pb_column et_pb_column_1_2  et_pb_column_1">
